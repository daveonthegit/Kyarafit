...
export default function ConventionDetailScreen() {
  ...
  const handleGeneratePacking = useCallback(async () => {
    ...
    try {
      ...
      router.push({ pathname: '/(tabs)/packing', params: { conventionId: id } });
    } finally {
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent}>
        ...
        <Pressable
          ...
          onPress={() => router.push({ pathname: '/(tabs)/packing', params: { conventionId: id } })}
        >
...
const styles = StyleSheet.create({
  ...
  syncLabel: { marginTop: 8, fontSize: 9, letterSpacing: 1.5, textTransform: 'uppercase', fontWeight: '600', color: colors.meta },
  sectionLabel: {
    fontSize: 9,
    letterSpacing: 2,
    textTransform: 'uppercase',
  ...
  planBuild: { flex: 1, fontSize: 14, fontFamily: font.serif, fontStyle: 'italic', color: colors.text },
  primaryBtn: {
  ...
  secondaryBtnText: { fontSize: 11, fontWeight: '600', textTransform: 'uppercase', letterSpacing: 2, color: colors.black },
  ...
  modalTitle: { fontFamily: font.serif, fontSize: 18, fontStyle: 'italic', marginBottom: 16 },
  modalOption: { paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: colors.borderSubtle },
  optionText: { fontSize: 14, color: colors.text },
  modalCancel: { marginTop: 16, alignItems: 'center' },
  cancelText: { fontSize: 10, textTransform: 'uppercase', letterSpacing: 2, color: colors.meta },
});
