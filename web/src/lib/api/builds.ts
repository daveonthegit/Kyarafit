...
export async function createBuildTask(buildId: string, input: CreateBuildTaskInput): Promise<BuildTask> {
...
export async function updateBuildTask(buildId: string, taskId: string, input: UpdateBuildTaskInput): Promise<BuildTask> {
