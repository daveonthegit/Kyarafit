...
export function FloatingAdd({
  ...
  return (
    <Link
      href={href}
      className={`fixed bottom-28 right-6 z-50 w-14 h-14 bg-black text-white flex items-center justify-center rounded-sm transition-transform hover:scale-95 active:scale-95 shadow-fab lg:hidden ${className}`.trim()}
      aria-label="Add item"
    >
