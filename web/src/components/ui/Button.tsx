...
const variantClasses: Record<Variant, string> = {
  ...
  text:
    'bg-transparent text-black border-0 border-b border-black rounded-none hover:opacity-80 focus:outline-none focus:border-kyar-accent focus:border-b-2 disabled:opacity-25',
};
