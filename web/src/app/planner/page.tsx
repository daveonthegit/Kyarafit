      ...
      <main className="flex-1 px-8">
        {view === 'daily' ? (
          <section className="mb-16">
            <h2 className="text-[10px] uppercase tracking-[0.2em] font-bold mb-8 border-b border-black pb-2 inline-block">Today&apos;s Priority</h2>
            ...
            {conventions.map((con) => (
              <div key={con.id} className="border-b border-gray-100 pb-6 group cursor-pointer">
                ...
                <div className="flex gap-4">
                  <Link href="/itinerary" className="text-[9px] uppercase tracking-widest border border-black/10 px-3 py-1">
                    Itinerary
                  </Link>
                  <Link href="/packing" className="text-[9px] uppercase tracking-widest border border-black/10 px-3 py-1">
                    Packing List
                  </Link>
                </div>
              </div>
