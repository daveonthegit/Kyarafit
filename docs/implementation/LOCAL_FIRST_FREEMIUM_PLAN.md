...
- DoD (full Phase 1): airplane-mode create/edit/delete across builds+tasks+conventions, relaunch online (paid), zero loss, no dupes (blueprint Phase 9 DoD subset).
