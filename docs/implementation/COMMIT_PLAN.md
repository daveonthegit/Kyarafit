...
| 2.2  | ~~Web planner: load tasks from Convex...~~ — **Done (2026-03-05):** buildTasks.listForPlanner; planner Daily (tasks, progress, deadline/other, checkbox, build link, timeframe, Add task); Conventions (real list + Itinerary/Packing); planner/page.test.tsx. | Planner shows real tasks; npm run validate passes                                                             |
