...
| 2.3 | Settings: add routes /settings/account, /settings/subscription, /settings/notifications; wire menu links; Account page (email, name, change password link)                              | Navigate to each settings page; account shows auth data                                                        |
| 2.4 | Settings: Subscription page (tier, usage from useTier; placeholder "Upgrade" link); Notifications placeholder                                                                           | Subscription page shows tier/usage                                                                             |
...
| 2.6 | Convex seed mutation: createStarter checks no builds then creates one build, one convention, one closet item linked; call from frontend or dashboard                                    | First-time user gets seed data once; idempotent                                                                |
